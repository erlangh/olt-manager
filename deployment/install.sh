...
# OLT Manager Installation Script for Ubuntu 24.04 LTS
# This script installs and configures the OLT Manager ZTE C320 application
...
SERVICE_USER="oltmanager"
DB_NAME="oltmanager_db"
DB_USER="oltmanager"
DB_PASSWORD="oltmanager_$(openssl rand -hex 8)"
PYTHON_VERSION="3.12"
NODE_VERSION="20"
